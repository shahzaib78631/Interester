...
CREATE TABLE answer_table (question_id INT, FOREIGN KEY (question_id) REFERENCES question_table(question_id), answer_id INT AUTO_INCREMENT, PRIMARY KEY (answer_id));
CREATE TABLE usr_answer_table (question_id INT, FOREIGN KEY (question_id) REFERENCES question_table(question_id), answer_id INT,  FOREIGN KEY (answer_id) REFERENCES answer_table(answer_id));
```